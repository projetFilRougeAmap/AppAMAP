...
class StockController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $stocks = $em->getRepository('AMAPBundle:Stock')->findAll();
    ...
    {
        $stock = new Stock();
        $form = $this->createForm('AMAPBundle\Form\StockType', $stock);
    ...
    {
        $deleteForm = $this->createDeleteForm($stock);
        $editForm = $this->createForm('AMAPBundle\Form\StockType', $stock);
