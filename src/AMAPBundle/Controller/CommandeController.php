...
use AMAPBundle\Entity\Commande;
use AMAPBundle\Form\CommandeType;
...
class CommandeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $commandes = $em->getRepository('AMAPBundle:Commande')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AMAPBundle\Form\CommandeType', $commande);
    ...
    {
        $deleteForm = $this->createDeleteForm($commande);
        $editForm = $this->createForm('AMAPBundle\Form\CommandeType', $commande);
