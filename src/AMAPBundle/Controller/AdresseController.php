...
use AMAPBundle\Form\AdresseType;
...
class AdresseController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $adresses = $em->getRepository('AMAPBundle:Adresse')->findAll();
    ...
    {
        $adresse = new Adresse();
        $form = $this->createForm('AMAPBundle\Form\AdresseType', $adresse);
    ...
    {
        $deleteForm = $this->createDeleteForm($adresse);
        $editForm = $this->createForm('AMAPBundle\Form\AdresseType', $adresse);
