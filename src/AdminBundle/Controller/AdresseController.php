...
use AdminBundle\Entity\Adresse;
use AdminBundle\Form\AdresseType;
...
class AdresseController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $adresses = $em->getRepository('AdminBundle:Adresse')->findAll();
    ...
    {
        $adresse = new Adresse();
        $form = $this->createForm('AdminBundle\Form\AdresseType', $adresse);
    ...
    {
        $deleteForm = $this->createDeleteForm($adresse);
        $editForm = $this->createForm('AdminBundle\Form\AdresseType', $adresse);
